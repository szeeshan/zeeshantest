...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    // This task will compile all less files upon saving to create both Admin Panel.css and Admin Panel.min.css
    less: {
      ...
      development: {
        ...
        files: {
          ...
          "dist/css/Admin Panel.css": "build/less/Admin Panel.less",
      ...
      production: {
        ...
        files: {
          // compilation.css  :  source.less
          "dist/css/Admin Panel.min.css": "build/less/Admin Panel.less",
          // Skins minified
